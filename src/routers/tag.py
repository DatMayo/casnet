...
async def get_tags(tenant_id: str, limit: int = 100, offset: int = 0):
...
async def create_tag(tenant_id: str, tag: Tag):
    """Create a new tag."""
...
async def delete_tag(tenant_id: str, tag_id: str):
